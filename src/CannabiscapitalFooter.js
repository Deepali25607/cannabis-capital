...
import footer from './images/footer-logo.png';
 class CannabiscapitalFooter extends Component {
    render() {
        return (
            <div>
                                    ...
                                    <div className="footercolWraper">
                                        <div className="footColOne">
                                            <ul className="footer_links">
                                                <li className="link_item"><a href="index.html">Home</a></li>
                                                <li className="link_item"><a href="intertainment.html">Intertainment</a></li>
                                                <li className="link_item"><a href="news.html">News</a></li>
                                                <li className="link_item"><a href="network.html">Networking</a></li>
                                                <li className="link_item"><a href="compound.html">Creative Compound</a></li>
                                                <li className="link_item"><a href="article.html">Articles</a></li>
                                                <li className="link_item"><a href="video.html">Videos</a></li>
                                            </ul>
                                        </div>
