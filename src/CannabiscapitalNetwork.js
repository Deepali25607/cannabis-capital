...
import networkbg from './images/network-bg.jpg';
import networkmain from './images/network-main.png';
import ccmembershi from './images/cc-membershi.png';
import ccevents from './images/cc-events.png';
import ccnetworking from './images/cc-networking.png';
...
import ccmarketing from './images/cc-marketing.png';
 function CannabiscapitalNetwork (){
        ...
        <div className="banner_box">
            <img src={networkbg} className="" alt="" />
        </div>
    </section>
